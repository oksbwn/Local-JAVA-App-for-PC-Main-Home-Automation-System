...
import javax.swing.*;
public class reminderShowFrame {
public static void main(String[] args)
  {
	new reminderShowFrame(0, 0, "bikash narayan anda", "745734653656354564");
	}
final JFrame frame=new JFrame();
public reminderShowFrame(int xpos,int ypos,String name,String no){
